...
//       <div className="w-full max-w-7xl flex flex-col md:flex-row gap-4 items-start justify-center" data-aos="fade-up">
//         {/* Left Info Section */}
//         <div className="w-full md:w-1/2 bg-white/60 backdrop-blur-md p-8 rounded-xl shadow-lg space-y-4" data-aos="fade-right">
...
//         {/* Right Form Section */}
//         <form onSubmit={handleSubmit} className="w-full md:w-1/2 bg-white/70 backdrop-blur-md rounded-xl shadow-xl p-8 space-y-6" data-aos="fade-left">
